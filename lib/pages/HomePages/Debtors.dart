...
class Debtors extends StatefulWidget {
  _DebitorsState createState() => _DebitorsState();
}

class _DebitorsState extends State<Debtors> {
  final dbHelper = DatabaseHelper.instance;
  Entry en;
  int ll;
  void insertData(Entry en) async {
    this.en = en;
    await dbHelper.insert(en, 'debit');
  }

  List<Entry> entries;

  queryAll() async {
    entries = await dbHelper.queryAll('debit');
    setState(() {});
  }
